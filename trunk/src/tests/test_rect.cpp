...
void Test_Rect::testConstructors() {
	...
	Rect r1(1.1f, 4.2f, 3.3f, 2.4f);
	CPPUNIT_ASSERT(	r1.getx1() == 1.1f && r1.gety1() == 4.2f && 
									r1.getx2() == 3.3f && r1.gety2() == 2.4f );

	Rect r2 = r1;
	CPPUNIT_ASSERT(r1 == r2);
	CPPUNIT_ASSERT(r2 == r1);
	CPPUNIT_ASSERT(	r2.getx1() == 1.1f && r2.gety1() == 4.2f && 
									r2.getx2() == 3.3f && r2.gety2() == 2.4f );
	...
	CPPUNIT_ASSERT(	r4.getx1() == d3 && r4.gety1() == d4 && 
									r4.getx2() == d1 && r4.gety2() == d2 );

	CPPUNIT_ASSERT(	r3.getx1() == d3 && r3.gety1() == d4 && 
									r3.getx2() == d1 && r3.gety2() == d2 );
...
void Test_Rect::testGetSet() {
	...
	r.Clear();
	r.sety1(d4); r.sety2(d3); r.Fix();
	CPPUNIT_ASSERT_EQUAL_MESSAGE("y1 should NOT have swapped", r.gety1(), d4);
	CPPUNIT_ASSERT_EQUAL_MESSAGE("y2 should NOT have swapped", r.gety2(), d3);
	...
	CPPUNIT_ASSERT_EQUAL_MESSAGE("x1 should NOT have swapped", r.getx1(), d1);
	CPPUNIT_ASSERT_EQUAL_MESSAGE("x2 should NOT have swapped", r.getx2(), d2);
	CPPUNIT_ASSERT_EQUAL_MESSAGE("y1 SHOULD have swapped", r.gety1(), d4);
	CPPUNIT_ASSERT_EQUAL_MESSAGE("y2 SHOULD have swapped", r.gety2(), d3);
