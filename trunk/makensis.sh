...
installerfile_part1=installer_files/installer_part1.txt
installerfile_part2=installer_files/installer_part2.txt
installerfile_part3=installer_files/installer_part3.txt
tmpfile=installer_files/tmpfile
...
echo "; Automatically generated NSI file from makensis.sh (Pirates Vs Ninjas)" > $outfile
